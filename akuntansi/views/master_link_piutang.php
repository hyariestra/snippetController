		...
		<div class="row" style="border-bottom:1px dashed #ccc; padding-bottom:10px; margin-bottom:10px;">
			<div class="col-md-6">
				<form id="formlinkakun" class="form-horizontal">
					...
					<?php 
					$arr = 0;
					foreach($pelanggan->result() as $rowPelanggan){
						...
						WHERE ref_link_piutang.id_kontak = '".$rowPelanggan->id_pelanggan."'
						AND ref_link_piutang.tipe = 'bkm'");
					?>
						<div class="form-group">
							<label class="col-md-3 control-label"><?php echo $rowPelanggan->nama_pelanggan?></label>
