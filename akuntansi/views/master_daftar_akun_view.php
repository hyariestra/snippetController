	...
	<div class="col-md-12">
		<div class="row" style="border-bottom:0px dashed #ccc; padding-bottom:10px; margin-bottom:10px;">
			<div class="row" style="border-bottom:0px dashed #ccc; padding-left:10px; padding-bottom:10px; margin-bottom:10px;">
				<button type="button" onclick="printkodeadkun()" class="btn btn-sm btn-success">
					<span class="glyphicon glyphicon-print"></span>
					Cetak Daftar Akun Excel
				</button>
				<button type="button" onclick="printkodeadkun2()" class="btn btn-sm btn-warning">
					<span class="glyphicon glyphicon-print"></span>
					Cetak Daftar Akun PDF
				</button>
				...
				*/ ?>
				...
				foreach($kodeakun as $rowAkun){
					...
					<tr id="datatable_" style="border-bottom:1px dashed #429489; background: <?php echo $background?>; color: <?php echo $color?>">
						...
						<td style="padding-right:50px; display:;" ><?php echo $rowAkun['kodeWithFormat']?></td>
...
<script type="text/javascript">
	...
	{  
		...
		function printkodeadkun()
		{

			var target = "<?php echo site_url("akuntansi/printkodeakun")?>/excel";
	
			window.open(target);

		}
		
		function printkodeadkun2()
		{

			var target = "<?php echo site_url("akuntansi/printkodeakun")?>/pdf";
