				...
				<form id="formlinkakun" class="form-horizontal">
					...
					?>
						...
						<div class="form-group">
							...
							<div class="col-md-12" style="background:#429489; padding:5px; color:#fff;">
							
								<b><?php echo $rowKategori->nama_kategori?></b>
							</div>
						</div>
					<?php
						...
						WHERE mst_item.id_kategori_item = '".$rowKategori->id_kategori_item."'");
						foreach($item->result() as $row){ ?>
						<input type="hidden" name="id_item[]" value="<?php echo $row->id_akunitem ?>">
						<div class="form-group">
							<label class="control-label col-md-4"><?php echo $row->nama_item?></label>
							<div class="col-md-8">
								<div class="input-group">
									<span class="input-group-addon"><?php echo @$row->kode_induk.".".@$row->kode_akun ?></span>
									<input type="hidden" id="akunref_<?php echo $arr?>" class="form-control" value="<?php echo @$row->id_akun?>" name="id_akun[]" />
