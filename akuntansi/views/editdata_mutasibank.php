...
<h4>Edit Mutasi Bank</h4>
<div class="widget-container" style="padding:10px;">
	<div class="col-md-12">
		<input type="hidden" name="idju" id="idju" value="<?php echo $idju?>" />
			...
			<div class="row" style="border-bottom:1px dashed #ccc; padding-bottom:10px; margin-bottom:10px;">
				<div class="col-md-6">
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							<input type="text" name="nomor" value="<?php echo $ju->first_row()->nomor?>"  class="form-control" />
						</div>
					</div>
					<div class="form-group">
						<label class="col-md-3 control-label">Nomor Bukti</label>
						<div class="col-md-9">
							<input type="text" name="nomorbukti" value="<?php echo $ju->first_row()->no_bukti?>"  class="form-control" />
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-md-9">
							<div class="input-group">
								...
								if(!empty($dari->first_row()->nama_akun))
								{
									echo "<input type='text' readonly value='{$dari->first_row()->nama_akun}' class='form-control' name='dari' />
									<input type='hidden' value={$dari->first_row()->id_akun} 
									style='text-align:right;' readonly class='form-control' name='idakun_dari' />";
								}
								else{
									echo "<input type=\"text\" readonly class=\"form-control\" name=\"dari\" />
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							<div class="input-group">
								<?php 
								if (!empty($ke->first_row()->nama_akun)) {
									echo	"<input type='text' readonly value='{$ke->first_row()->nama_akun}' class='form-control' name='ke' />
									<input type='hidden' value='{$ke->first_row()->id_akun}' style='text-align:right;' readonly class='form-control' name='idakun_ke' />";
								}else{
									echo "<input type=\"text\" readonly class=\"form-control\" name=\"ke\" />
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							<div class="input-group">
								...
								<?php 
								if (!empty($dari->first_row()->kredit)) {

									echo "<input type='text' style='text-align:right;' value='{$dari->first_row()->kredit}' class='form-control' onkeyup='formatNumber(this)' name='nominal' />";
								}
								else {
									echo "<input type=\"text\" style=\"text-align:right;\" class=\"form-control\" onkeyup=\"formatNumber(this)\" name=\"nominal\" />";
								}
								?>
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							<textarea rows="6" type="text" name="uraian" class="form-control">

								<?php echo $ju->first_row()->uraians ?>
...
<script type="text/javascript">
    ...
    function simpandata()
    {
    	...
    	var target = "<?php echo site_url("akuntansi/updatedataMutasiBank")?>";
