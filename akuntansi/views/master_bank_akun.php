  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header" style="padding:10px 10px 0px 0px !important;">
        ...
        <h5 style="padding: 0px 15px 0px 15px;">Tambah Kas Bank</h5>
      </div>
	        ...
	        <div class="col-md-12">
				<div style="background:#429489;min-height:0px;" class="widget-container padded">
					<table class="table table-bordered tsble-striped" style="background:#fff;">
						...
						<tr>
							<td class="form-input labelinput">* Nama kas Bank</td>
							<td class="form-input">
								<div class="col-md-12">
						...
						<tr>
							...
							<td class="form-input">
								<div class="col-md-12">
									<select class="form-control" name="new_dep">
...
<div class="modal fade" id="modalubah">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header" style="padding:10px 10px 0px 0px !important;">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h5 style="padding: 0px 15px 0px 15px;">Edit Kas Bank</h5>
      </div>
      <div class="modal-body">
        <div class="row">
