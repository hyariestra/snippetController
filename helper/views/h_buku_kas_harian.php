...
<body>
	...
	<div class="modal-shiftfix" style="position:relative; background:#ccc;">
		...
		<div class="container-fluid main-content">
			<div class="row">
				<div class="col-lg-12">
				<h3>Menampilkan Laporan Buku Kas Harian</h3>
					<div class="thumbnail">
					<img alt="imgscreenshot" style ="height:300px; width:75%; display: block;" src="../assets/images/screenshots/buku_kas_harian.png" data-holder-rendered="true">
					<div class="caption">
					<h3> Screenshot Buku Kas Harian</h3>
					<p> Modul ini digunakan untuk menampilkan laporan buku kas harian.</p>
					<ul class="listimage">
					<li>Tekan button cari data untuk menampilkan preview laporan buku kas harian yang dicari</li>
					<li>Tekan button print data untuk mencetak data laporan laporan buku kas harian</li>
					<li>Tekan button batal untuk membersihkan preview laporan buku kas harian</li>
					</ul>
					</div>
					</img>
					</div>
