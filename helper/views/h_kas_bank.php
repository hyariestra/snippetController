...
<body>
	...
	<div class="modal-shiftfix" style="position:relative; background:#ccc;">
		...
		<div class="container-fluid main-content">
			<div class="row">
				<div class="col-lg-12">
				<h3>Mengelola Data Kas/Bank</h3>
					
					<div class="thumbnail">
					<img alt="imgscreenshot" style ="height:300px; width:75%; display: block;" src="../assets/images/screenshots/kas_bank.png" data-holder-rendered="true">
					<div class="caption">
					<h3> Screenshot kas/Bank</h3>
					<p> Modul ini digunakan untuk persiapan awal yang berhubungan dengan kas/bank yang akan digunakan.</p>
					<ul class="listimage">
					<li>Tekan button hijau (plus) untuk menambahkan kas/bank</li>
					<li>Tekan button kuning (pensil) untuk mengubah kas/bank</li>
					<li>Tekan button merah (tong sampah) untuk menghapus kas/bank</li>
					</ul>
					</div>
					</img>
					</div>
