...
<body>
	...
	<div class="modal-shiftfix" style="position:relative; background:#ccc;">
		...
		<div class="container-fluid main-content">
			<div class="row">
				<div class="col-lg-12">
				<h3>Menambah Data Mutasi Bank</h3>
					<div class="thumbnail">
					<img alt="imgscreenshot" style ="height:300px; width:75%; display: block;" src="../assets/images/screenshots/tambah_mutasi_bank.png" data-holder-rendered="true">
					<div class="caption">
					<h3> Screenshot Tambah Mutasi Bank</h3>
					<p> Modul ini digunakan untuk menambah data mutasi bank.</p>
					<ul class="listimage">
					<li>Tekan button simpan data untuk menyimpan data</li>
					<li>Tekan button daftar mutasi bank untuk melihat daftar mutasi bank</li>
					</ul>
					</div>
					</img>
					</div>
