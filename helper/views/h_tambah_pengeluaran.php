		...
		<div class="container-fluid main-content">
			<div class="row">
				...
				<h3>Mengelola Data Pengeluaran</h3>
					...
					<div class="thumbnail">
					<img alt="imgscreenshot" style ="height:300px; width:75%; display: block;" src="../assets/images/screenshots/tambah_pengeluaran.png" data-holder-rendered="true">
					<div class="caption">
					<h3> Screenshot Pengeluaran</h3>
					<p> Modul ini digunakan untuk menambah data pengeluaran.</p>
					<ul class="listimage">
					
					<li>Untuk menambah detail transaksi tekan button plus</li>
					<li>Untuk menghapus detail transaksi tekan button merah (tong sampah)</li>
					<li>Tekan button simpan data untuk menyimpan data</li>
					<li>Tekan button cetak & simpan data untuk simpan sekaligus cetak data</li>
					<li>Tekan daftar BKK untuk melihat daftar buku kas keluar yang sudah tersimpasn</li>
					</ul>
					</div>
					</img>
					</div>
