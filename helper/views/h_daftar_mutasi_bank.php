...
<body>
	...
	<div class="modal-shiftfix" style="position:relative; background:#ccc;">
		...
		<div class="container-fluid main-content">
			<div class="row">
				<div class="col-lg-12">
				<h3>Mengolah Data Daftar Mutasi Bank</h3>
					<div class="thumbnail">
					<img alt="imgscreenshot" style ="height:300px; width:75%; display: block;" src="../assets/images/screenshots/daftar_mutasi_bank.png" data-holder-rendered="true">
					<div class="caption">
					<h3> Screenshot Daftar Mutasi Bank</h3>
					<p> Modul ini digunakan untuk mengolah data mutasi bank.</p>
					<ul class="listimage">
					<li>Tekan button tambah untuk menambah mutasi bank</li>
					<li>Tekan button kuning(pensil) untuk mengubah data</li>
					<li>Tekan button merah (tong sampah) untukk menghapus data</li>
					<li>Untuk memilih data yang akan dihapus, centang pada check box lalu tekan delete</li> 
					</ul>
					</div>
					</img>
					</div>
