...
<body>
	...
	<div class="modal-shiftfix" style="position:relative; background:#ccc;">
		...
		<div class="container-fluid main-content">
			<div class="row">
				<div class="col-lg-12">
				<h3>Mengelola Data Departemen/Unit</h3>
					
					<div class="thumbnail">
					<img alt="imgscreenshot" style ="height:300px; width:75%; display: block;" src="../assets/images/screenshots/unit.png" data-holder-rendered="true">
					<div class="caption">
					<h3> Screenshot Unit</h3>
					<p> Modul ini digunakan untuk persiapan awal yang berhubungan dengan Departement dan unit yang akan digunakan.</p>
					<ul class="listimage">
					<li>Tekan button hijau (plus) untuk menambahkan Departemen/Unit</li>
					<li>Tekan button kuning (pensil) untuk mengubah Departemen/Unit</li>
					<li>Tekan button merah (tong sampah) untuk menghapus Departemen/Unit</li>
					</ul>
					</div>
					</img>
					</div>
