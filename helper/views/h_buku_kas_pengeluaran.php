...
<body>
	...
	<div class="modal-shiftfix" style="position:relative; background:#ccc;">
		...
		<div class="container-fluid main-content">
			<div class="row">
				<div class="col-lg-12">
				<h3>Menampilkan Laporan Buku Kas Pengeluaran</h3>
					<div class="thumbnail">
					<img alt="imgscreenshot" style ="height:300px; width:75%; display: block;" src="../assets/images/screenshots/buku_kas_pengeluaran.png" data-holder-rendered="true">
					<div class="caption">
					<h3> Screenshot Buku Kas Pengeluaran</h3>
					<p> Modul ini digunakan untuk menampilkan laporan buku kas pengeluaran.</p>
					<ul class="listimage">
					<li>Tekan button cari data untuk menampilkan preview laporan buku kas pengeluaran yang dicari</li>
					<li>Tekan button print data untuk mencetak data laporan laporan buku kas pengeluaran</li>
					</ul>
					</div>
					</img>
					</div>
