...
<body>
	...
	<div class="modal-shiftfix" style="position:relative; background:#ccc;">
		...
		<div class="container-fluid main-content">
			<div class="row">
				<div class="col-lg-12">
				<h3>Mengolah Data Group User</h3>
					<div class="thumbnail">
					<img alt="imgscreenshot" style ="height:300px; width:75%; display: block;" src="../assets/images/screenshots/group_user.png" data-holder-rendered="true">
					<div class="caption">
					<h3> Screenshot Data Group User</h3>
					<p> Modul ini digunakan untuk mengolah data group user.</p>
					<ul class="listimage">
					<li>Tekan button tambah untuk menambah group user</li>
