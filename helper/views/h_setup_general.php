...
<body>
	...
	<div class="modal-shiftfix" style="position:relative; background:#ccc;">
		...
		<div class="container-fluid main-content">
			<div class="row">
				<div class="col-lg-12">
				<h3>Mengelola Data Setup General</h3>
					
					<div class="thumbnail">
					<img alt="imgscreenshot" style ="height:300px; width:75%; display: block;" src="../assets/images/screenshots/setup_general.png" data-holder-rendered="true">
					<div class="caption">
					<h3> Screenshot Setup General</h3>
					<p> Modul ini digunakan untuk persiapan awal yang berhubungan dengan setup general label yang berkenaan dengan laporan keuangan.</p>
					<ul class="listimage">
					<li>Isi label lembaga</li>
					<li>Isi label Aplikasi</li>
					<li>Isi label Pelanggan</li>
					<li>Isi label Pemasok</li>
					<li>Isi label Header</li>
					<li>Isi label Laporan</li>
					<li>Isi label Tambahan</li>
					<li>Isi label Perubahan Ekuitas</li>
