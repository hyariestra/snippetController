...
<body>
	...
	<div class="modal-shiftfix" style="position:relative; background:#ccc;">
		...
		<div class="container-fluid main-content">
			<div class="row">
				<div class="col-lg-12">
				<h3>Setting akses modul untuk user</h3>
					<div class="thumbnail">
					<img alt="imgscreenshot" style ="height:300px; width:75%; display: block;" src="../assets/images/screenshots/setting_user.png" data-holder-rendered="true">
					<div class="caption">
					<h3> Screenshot Setting User</h3>
					<p> Modul ini digunakan untuk mengatur akses modul yang akan digunakan user.</p>
					<ul class="listimage">
					<li>Pilih group user yang akan di setting</li>
					<li>Centang pada check box untuk memilih modul yang akan digunakan</li>
					<li>Tekan button simpan data untuk menyimpan data pengaturan</li>
					</ul>
					</div>
					</img>
					</div>
