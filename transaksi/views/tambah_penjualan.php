...
<div class="modal fade" id="modalTambahItem">
	...
	$(document).ready(function(){
		...
		.on('changeDate', function(e){
			...
			if(kasbank == "-")
			{
				alert("Silahkan input metode bayar dan kas bank.");
				return false;
			}
	...
	function openpelanggan()
	{
		...
		$.post(target, data, function(e){
				...
				{
					alert("Silahkan isi data pelanggan terlebih dahulu.");
				}
			});
	}
	...
	{
		var target = "<?php echo site_url("transaksi/getautonumberchangePenjualan")?>";
			data = {
				kasbank : kasbank,
				bulan : bulan,
				tahun : tahun
    ...
    function daftar()
    {
    	...
    	var target = "<?php echo site_url("transaksi/penjualan")?>";
