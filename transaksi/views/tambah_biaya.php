...
<?php
$iditem = $this->db->query("SELECT * FROM mst_item WHERE mst_item.nama_item LIKE '%Biaya%'");
?>
								...
								<tr>
									...
									<td>
										<div class="input-group">
											...
											<input style="text-align:right;" type="text" onkeyup="formatNumber(this)" onblur="akumulasi2(this)" role="inputtext" class="form-control" name="harga[]" />
									...
									<td>
										<div class="input-group">
											<span class="input-group-addon">Rp. </span>
											<input style="text-align:right;" readonly type="text" value="0,00" role="inputtext" class="form-control" />
										</div>
									</td>
									<td>
...
<script type="text/javascript">
	...
	function tambahrow()
	{
		...
		var Total = "<div class='input-group'>";
			...
			Total += "<input style='text-align:right;' class='form-control' readonly role='inputtext' value='0,00' onkeyup='formatNumber(this)' name='potongan[]' />";
			Total += "</div>";
	...
	function getnumbertransaksibiaya()
	{
		var target = "<?php echo site_url("transaksi/getnumberbiaya")?>";
    ...
    function simpandata()
    {
    	...
    	var target = "<?php echo site_url("transaksi/simpanbiaya")?>";
    	data = {
    ...
    function akumulasi(obj)
    {
    	...
    	$(obj).parent().parent().find("td").eq(6).find("input:first").val(total);
	...
	function cetaksimpan()
	{
		...
		var target = "<?php echo site_url("transaksi/simpancetakbiaya")?>";
