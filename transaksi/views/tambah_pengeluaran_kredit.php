...
<h4>Tambah Pengeluaran Kredit</h4>
				...
				<div class="form-horizontal">
					<div class="col-md-6">
						<div class="form-group">
							<label class="col-md-3 control-label">Mustahiq</label>
							<div class="col-md-8">
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header" style="padding:10px 10px 0px 0px !important;">
				...
				<h5 style="padding: 0px 15px 0px 15px;">Data Mustahiq</h5>
			</div>
						...
						<div style="background:#429489;min-height:0px;" class="widget-container padded">
							<div class="xx">
								<form class="up" role="search" action="" method="post">
									<div class="input-group">
										<input type="text" id="s_cari" class="form-control" name="kata_kunci" placeholder="cari mustahiq...">
...
<div class="modal fade" id="modalTambahItem">
	...
	<script type="text/javascript">
		...
		{
			var target = "<?php echo site_url("transaksi/getpemasokkredit")?>";
    ...
    function simpandata()
    {
    	...
    	var target = "<?php echo site_url("transaksi/simpandatapengeluarankredit")?>"
    	data = {
