...
<page footer="page">
	...
	<div style="font-family:tahoma;text-align:center;">
		<h4 style="text-decoration:underline; line-height:5px;">Print Rekap Mutasi</h4>
	</div>
	...
	<div style="margin-top:30px;">
		<table border="1" width="680" style="border-collapse:collapse;max-width:100%;table-layout:fixed;">
			<tr>
				...
				<th class="coll-td" style="width:15%;"> Nomor Bukti </th>
				<th class="coll-td"> Nomor </th>
				<th class="coll-td" style="width:25%;"> Uraian </th>
			...
			<tr>
				...
				<td class="coll-td"> <?php echo $rows['nm']?> </td>
				<td class="coll-td"> <?php echo $rows['nmtok']?> </td>
				<td class="coll-td"> <?php echo $rows['uraian']?> </td>
			...
			<tr>
				<td class="coll-td" colspan="5" style="text-align: right;">Total Pendapatan</td>
