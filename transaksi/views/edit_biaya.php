...
<div class="widget-container" style="padding:10px;">
	<div class="row">
		<input type="hidden" id="id_biaya" value="<?php echo $biaya->first_row()->id_pembelian;?>">
		<div class="col-md-12">
				...
				<div class="form-horizontal">
					<div class="col-md-6">
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<input type="text" class="form-control" value="<?php echo $biaya->first_row()->nomor_transaksi?>" name="no_transaksi"/>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-md-8">
								<div class="input-group">
									<input type="text" value="<?php echo date("d-m-Y", strtotime($biaya->first_row()->tanggal))?>" readonly role="tanggal" class="form-control" name="tgl_transaksi"/>
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							<div class="col-md-8">
								<select  class="form-control" name="id_metodebayar">
									...
									?>
										<option <?php if($row->id_metode_bayar == $biaya->first_row()->id_metode_bayar){ echo "selected='selected'";} ?> value="<?php echo $row->id_metode_bayar?>"><?php echo $row->nama_metode_bayar?></option>
									<?php
										}
									?>
								</select>
						...
						<?php 
							//$display = ($biaya->first_row()->id_metode_bayar == 1) ? "display:none" : "";
						?>
						<div class="form-group" id="changebank">
							...
							<div class="col-md-8">
								<select class="form-control" name="id_bank">
									...
									?>
										<option <?php if($row->id_bank == $biaya->first_row()->id_bank) { echo "selected='selected'"; } ?> value="<?php echo $row->id_bank?>"><?php echo $row->nama_bank?></option>
									<?php
										}
									?>
								</select>
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<textarea class="form-control" name="keterangan" rows="6">
									<?php echo $biaya->first_row()->deskripsi?>
								</textarea>
							</div>
						</div>
					</div>
							...
							<tbody id="dataitem">
								...
								?>
										<tr>
											...
											<td><input type="text" value="<?php echo $row->memo?>" role="inputtext" class="form-control" name="memo[]" /></td>
											
											<td>
												<div class="input-group">
													<span class="input-group-addon">Rp. </span>
													<input type="text" style="text-align:right;" onkeyup="formatNumber(this)" onblur="akumulasi2(this)" role="inputtext" class="form-control" value="<?php echo number_format($row->harga)?>" name="harga[]" />
												</div>
											</td>
...
<script type="text/javascript">
	...
	function tambahrow()
	{
		...
		var Checkedbox = "<input type='checkbox' style='display:block;' />";
			Checkedbox += '<input value="'+iditem+'" readonly type="hidden" role="inputtext" class="form-control" name="item[]" />';
	...
	function simpandata()
	{
		...
		var target = "<?php echo site_url("transaksi/simpaneditdatabiaya")?>"
			data = {
				idbiaya : $("#id_biaya").val(),
		...
		$.post(target, data, function(e){
			...
			var html = "<?php echo site_url("transaksi/biaya")?>";
    ...
    {
    	var target = "<?php echo site_url("transaksi/simpancetakbiayaubah")?>";
