			...
			<div class="row" style="border-bottom:1px dashed #ccc; padding-bottom:10px; margin-bottom:10px;">
				<div class="btn">
					<a href="javascript:toggleDiv('myContent');" class="btn btn-sm btn-success">
						<span class="glyphicon glyphicon-list"></span>&nbsp;Daftar BKM Penerimaan Lain-lain
					</a>
				</div>
...
<script type="text/javascript">
	...
	function deletedata(obj)
	{
		...
		var target = "<?php echo site_url("transaksi/deletedatapenerimaanlain")?>";
		data = {
			idpenerimaanlain : IDx
		}
		// console.log(IDx);
		//alert(IDx)
	...
	function deleteall()
	{
		...
		if (ids.length) {
			$.ajax({
				type: 'POST',
				url: "<?php echo site_url("transaksi/deleteallpenerimaanlain")?>",
				data: {
					idpenjualan: ids
				},
