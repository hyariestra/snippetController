	...
	<div style="margin-top:30px;">
		<table border=1 width="680" style="border-collapse:collapse;max-width:100%;table-layout:fixed;">
			<tr>
				...
				<th class="coll-td" style="width:20%;"> Pemasok </th>
			...
			<tr>
				...
				<td class="coll-td"> <?php echo $rows['nama_pemasok']?> </td>
				<td class="coll-td"> <?php echo $rows['nomor_transaksi']?> </td>
				<td class="coll-td"> <?php echo $rows['nama_metode_bayar']?> </td>
				<td class="coll-td"> <?php echo $rows['nama_bank']?> </td>
				<td class="coll-td"> <?php echo $rows['deskripsi']?> </td>
