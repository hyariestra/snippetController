...
<h4>Tambah Penerimaan Secara Kredit</h4>
...
<div class="modal fade" id="modalTambahItem">
	...
	<script type="text/javascript">
		...
		{
			var target = "<?php echo site_url("transaksi/getnumbertransaksikredit")?>";
    ...
    function simpandata()
    {
    	...
    	var target = "<?php echo site_url("transaksi/simpandatabkmkredit")?>"
    	data = {
