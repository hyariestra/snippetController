<?php
	...
	$tanggal = date("Y-m-d", strtotime($penjualan->first_row()->tanggal_penjualan));
	...
	$notransaksi = $penjualan->first_row()->no_transaksi;
			...
			<div class="row" style="border-bottom:1px dashed #ccc; padding-bottom:10px; margin-bottom:10px;">
				...
				<div class="form-horizontal">
					<div class="col-md-6">
							...
							<div class="col-md-8">
								<select onchange="pilihkasbank(this)" class="form-control" name="id_metodebayar">
									...
									foreach($metodebayar->result() as $row){
										?>
										<option <?php if($row->id_metode_bayar == $penjualan->first_row()->id_metode_bayar){ echo "selected='selected'";} ?> value="<?php echo $row->id_metode_bayar?>"><?php echo $row->nama_metode_bayar?></option>
										<?php
									}
									?>
								</select>
						...
						<div id="kasbankx">
							<div class="form-group" id="changebank" >
								...
								<div class="col-md-8">
									<select class="form-control" onchange="getkasbank()" id="idbank" name="id_bank">
										<option value="-">:: Pilih Bank ::</option>
										<?php
										foreach($bank->result() as $row){
											?>
											<option <?php if($row->id_bank == $penjualan->first_row()->id_bank) { echo "selected='selected'"; } ?> value="<?php echo $row->id_bank?>"><?php echo $row->nama_bank?></option>
											<?php
										}
										?>
									</select>
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<input type="hidden" class="form-control" value="<?php echo $penjualan->first_row()->nama_departemen?>" name="namaunit"/>
								<input type="hidden" class="form-control" value="<?php echo $penjualan->first_row()->nama_bank?>" name="namabank"/>
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<label class="col-md-3 control-label"><?php echo $setting->first_row()->label_pelanggan?></label>
							<div class="col-md-8">
								<div class="input-group">
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header" style="padding:10px 10px 0px 0px !important;">
				...
				<h5 style="padding: 0px 15px 0px 15px;">Data <?php echo $setting->first_row()->label_pelanggan?></h5>
			</div>
				...
				<div class="row">
					<div class="col-md-12">
						...
						<div style="background:#429489;min-height:0px;" class="widget-container padded">
							...
							<table class="table table-bordered table-striped" style="background:#fff;">
								<thead>
									<tr>
										<th>#</th>
										<th>Nama <?php echo $setting->first_row()->label_pelanggan?></th>
										<th>Alamat</th>
										<th>Aksi</th>
									</tr>
								</thead>
						...
						<button type="button" onclick="tambahpelanggan()" class="btn btn-sm btn-default" style="margin-top:10px;">
							...
							tambah <?php echo $setting->first_row()->label_pelanggan?>
						</button>
					</div>
				</div>
			</div>
			<div class="modal-footer customefooter" style="text-align:left !important;">
				<ul>
					Note :
					<li><?php echo $setting->first_row()->label_pelanggan?> dapat dipilih lebih dari satu, kemudian klik tombol sebelah kanan.</li>
					<li>Tombol "tambah <?php echo $setting->first_row()->label_pelanggan?>" untuk input data <?php echo $setting->first_row()->label_pelanggan?> bila tidak ada pada list.</li>
				</ul>
			</div>
		</div><!-- /.modal-content -->
	</div><!-- /.modal-dialog -->
...
<div class="modal fade" id="modalTambahPelanggan">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header" style="padding:10px 10px 0px 0px !important;">
				<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>    
				<h5 style="padding: 0px 15px 0px 15px;">Tambah Data <?php echo $setting->first_row()->label_pelanggan?></h5>
			</div>
			<div class="modal-body">
				<div class="row">
					<div class="col-md-12">
						<div style="background:#429489;min-height:0px;" class="widget-container padded">
							<form id="formtambahpelanggan">
								<table class="table table-bordered table-striped" style="background:#fff;">
									<tr>
										<td>Nama <?php echo $setting->first_row()->label_pelanggan?></td>
									...
									<tr>
										<td>Alamat <?php echo $setting->first_row()->label_pelanggan?></td>
										<td>
						...
						<button id="btnsimpan" type="button" onclick="simpanpelanggan()" class="btn btn-sm btn-default" style="margin-top:10px;">
							<span class="glyphicon glyphicon-plus-sign"></span>
							simpan <?php echo $setting->first_row()->label_pelanggan?>
						</button>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$("#s_form").submit(function(e){
			e.preventDefault();
			var target = "<?php echo site_url("transaksi/cariitempenjualan")?>";
				data = {
	...
	function getautonumberchange(idpenjualan, kasbank, bulan, tahun)
	{
		var target = "<?php echo site_url("transaksi/getautonumberchangePenjualanEdit")?>";
			data = {
				kasbank : kasbank,
				bulan : bulan,
				tahun : tahun,
    ...
    function simpandata()
    {
    	...
    	var target = "<?php echo site_url("transaksi/simpaneditdatabkm")?>"
    	data = {
    		idpenjualan : $("#id_penjualan").val(),
