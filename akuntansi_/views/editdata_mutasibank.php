			...
			<div class="row" style="border-bottom:1px dashed #ccc; padding-bottom:10px; margin-bottom:10px;">
				<div class="col-md-6">
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							<div class="input-group">
								<input type="text" readonly value="<?php echo $dari->first_row()->nama_akun?>" class="form-control" name="dari" />
								<input type="hidden" value="<?php echo $dari->first_row()->id_akun?>" style="text-align:right;" readonly class="form-control" name="idakun_dari" />
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							<div class="input-group">
								<input type="text" readonly value="<?php echo $ke->first_row()->nama_akun?>" class="form-control" name="ke" />
								<input type="hidden" value="<?php echo $ke->first_row()->id_akun?>" style="text-align:right;" readonly class="form-control" name="idakun_ke" />
								<span onclick="openkodeakun(this)"  class="input-group-addon glyphicon glyphicon-search"></span>
							</div>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-md-9">
							<div class="input-group">
								...
								<input type="text" style="text-align:right;" value="<?php echo number_format($dari->first_row()->kredit)?>" class="form-control" onkeyup="formatNumber(this)" name="nominal" />
							</div>
						</div>
					</div>
					<div class="form-group">
