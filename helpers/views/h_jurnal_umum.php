...
<body>
	...
	<div class="modal-shiftfix" style="position:relative; background:#ccc;">
		...
		<div class="container-fluid main-content">
			<div class="row">
				<div class="col-lg-12">
				<h3>Mengolah Data Jurnal Umum</h3>
					<div class="thumbnail">
					<img alt="imgscreenshot" style ="height:300px; width:75%; display: block;" src="../assets/images/screenshots/jurnal_umum.png" data-holder-rendered="true">
					<div class="caption">
					<h3> Screenshot Jurnal Umum</h3>
					<p> Modul ini digunakan untuk mengolah data jurnal umum.</p>
					<ul class="listimage">
					<li>Tekan button tambah data untuk menambah data</li>
					<li>Tekan button daftar jurnal umum untuk mencari data jurnal umum</li>
					</ul>
					</div>
					</img>
					</div>
