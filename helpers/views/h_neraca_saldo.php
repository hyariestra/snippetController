...
<body>
	...
	<div class="modal-shiftfix" style="position:relative; background:#ccc;">
		...
		<div class="container-fluid main-content">
			<div class="row">
				<div class="col-lg-12">
				<h3>Menampilkan Laporan Neraca Saldo</h3>
					<div class="thumbnail">
					<img alt="imgscreenshot" style ="height:300px; width:75%; display: block;" src="../assets/images/screenshots/neraca_saldo.png" data-holder-rendered="true">
					<div class="caption">
					<h3> Screenshot Laporan Neraca Saldo</h3>
					<p> Modul ini digunakan untuk menampilkan laporan neraca saldo.</p>
					<ul class="listimage">
					<li>Tekan button preview data untuk menampilkan preview laporan buku jurnal</li>
					<li>Tekan button print dat untuk mencetak data laporan laporan buku jurnal</li>
					</ul>
					</div>
					</img>
					</div>
