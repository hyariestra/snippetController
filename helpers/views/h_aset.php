...
<body>
	...
	<div class="modal-shiftfix" style="position:relative; background:#ccc;">
		...
		<div class="container-fluid main-content">
			<div class="row">
				<div class="col-lg-12">
				<h3>Mengelola Data Aset</h3>
					
					<div class="thumbnail">
					<img alt="imgscreenshot" style ="height:300px; width:75%; display: block;" src="../assets/images/screenshots/aset.png" data-holder-rendered="true">
					<div class="caption">
					<h3> Screenshot Aset</h3>
					<p> Modul ini digunakan untuk persiapan awal yang berhubungan dengan aset yang akan digunakan.</p>
					<ul class="listimage">
					<li>Tekan button hijau (plus) untuk menambahkan aset</li>
					<li>Tekan button kuning (pensil) untuk mengubah aset</li>
					<li>Tekan button merah (tong sampah) untuk menghapus aset</li>
					</ul>
					</div>
					</img>
					</div>
