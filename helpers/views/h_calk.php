...
<body>
	...
	<div class="modal-shiftfix" style="position:relative; background:#ccc;">
		...
		<div class="container-fluid main-content">
			<div class="row">
				<div class="col-lg-12">
				<h3>Menampilkan Catatan Atas Laporan Keuangan (CALK)</h3>
					<div class="thumbnail">
					<img alt="imgscreenshot" style ="height:300px; width:75%; display: block;" src="../assets/images/screenshots/laporan_calk.png" data-holder-rendered="true">
					<div class="caption">
					<h3> Screenshot laporan CALK</h3>
					<p> Modul ini digunakan untuk menampilkan CALK.</p>
					<ul class="listimage">
					<li>Tekan button print preview untuk untuk menampilkan narasi CALK</li>
					<li>Tekan button print data untuk untuk mencetak narasi CALK</li>
					</ul>
					</div>
					</img>
					</div>
