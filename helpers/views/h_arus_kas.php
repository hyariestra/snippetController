...
<body>
	...
	<div class="modal-shiftfix" style="position:relative; background:#ccc;">
		...
		<div class="container-fluid main-content">
			<div class="row">
				<div class="col-lg-12">
				<h3>Menampilkan Laporan Arus Kas</h3>
					<div class="thumbnail">
					<img alt="imgscreenshot" style ="height:300px; width:75%; display: block;" src="../assets/images/screenshots/arus_kas.png" data-holder-rendered="true">
					<div class="caption">
					<h3> Screenshot Laporan Arus Kas</h3>
					<p> Modul ini digunakan untuk menampilkan laporan arus kas.</p>
					<ul class="listimage">
					<li>Tekan button preview data untuk menampilkan preview laporan arus kas</li>
					<li>Tekan button print data untuk mencetak data laporan arus kas</li>
					</ul>
					</div>
					</img>
					</div>
