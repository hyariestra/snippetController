...
<body>
	...
	<div class="modal-shiftfix" style="position:relative; background:#ccc;">
		...
		<div class="container-fluid main-content">
			<div class="row">
				<div class="col-lg-12">
				<h3>Menampilkan Laporan Buku Jurnal</h3>
					<div class="thumbnail">
					<img alt="imgscreenshot" style ="height:300px; width:75%; display: block;" src="../assets/images/screenshots/buku_jurnal.png" data-holder-rendered="true">
					<div class="caption">
					<h3> Screenshot Buku Jurnal Jurnal</h3>
					<p> Modul ini digunakan untuk menampilkan laporan buku jurnal.</p>
					<ul class="listimage">
