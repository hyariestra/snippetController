...
<body>
	...
	<div class="modal-shiftfix" style="position:relative; background:#ccc;">
		...
		<div class="container-fluid main-content">
			<div class="row">
				<div class="col-lg-12">
				<h3>Mencari Data Penerimaan</h3>
					<div class="thumbnail">
					<img alt="imgscreenshot" style ="height:300px; width:75%; display: block;" src="../assets/images/screenshots/cari_bkm.png" data-holder-rendered="true">
					<div class="caption">
					<h3> Screenshot Pencarian BKM</h3>
					<p> Modul ini digunakan untuk mencari data BKM.</p>
					<ul class="listimage">
					<li>Inputkan isi form pencarian data BKM</li>
