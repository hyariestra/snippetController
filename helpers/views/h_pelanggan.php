...
<body>
	...
	<div class="modal-shiftfix" style="position:relative; background:#ccc;">
		...
		<div class="container-fluid main-content">
			<div class="row">
				<div class="col-lg-12">
				<h3>Mengelola Data Pelanggan</h3>
					
					<div class="thumbnail">
					<img alt="imgscreenshot" style ="height:300px; width:75%; display: block;" src="../assets/images/screenshots/pelanggan.png" data-holder-rendered="true">
					<div class="caption">
					<h3> Screenshot Data Pelanggan</h3>
					<p> Modul ini digunakan untuk persiapan awal yang berhubungan dengan data pelanggan.</p>
					<ul class="listimage">
					<li>Untuk menambah data klik tombol "Tambah"</li>
					<li>Untuk mengubah data mata uang, klik tombol kuning (pensil)</li>
					<li>Untuk menghapus data mata uang, klik tombol merah (tong sampah)</li>
					</ul>
					</div>
					</img>
					</div>
