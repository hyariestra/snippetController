...
<body>
	...
	<div class="modal-shiftfix" style="position:relative; background:#ccc;">
		...
		<div class="container-fluid main-content">
			<div class="row">
				<div class="col-lg-12">
				<h3>Mengolah Data Jurnal</h3>
					<div class="thumbnail">
					<img alt="imgscreenshot" style ="height:300px; width:75%; display: block;" src="../assets/images/screenshots/posting.png" data-holder-rendered="true">
					<div class="caption">
					<h3> Screenshot Posting Jurnal</h3>
					<p> Modul ini digunakan untuk melakukan posting jurnal.</p>
					<ul class="listimage">
					<li>Tekan button posting jurnal untuk melakukan posting jurnal</li>
					</ul>
					<span>*note apabila tampilan berubah menjadi kosong, maka posting telah berhasil dilakukan</span>
					</div>
					</img>
					</div>
				</div>
