...
<body>
	...
	<div class="modal-shiftfix" style="position:relative; background:#ccc;">
		...
		<div class="container-fluid main-content">
			<div class="row">
				<div class="col-lg-12">
				<h3>Mengelola Data Kode Akun</h3>
					
					<div class="thumbnail">
					<img alt="imgscreenshot" style ="height:300px; width:75%; display: block;" src="../assets/images/screenshots/kode_akun.png" data-holder-rendered="true">
					<div class="caption">
					<h3> Screenshot Kode Akun</h3>
					<p> Modul ini digunakan untuk persiapan awal yang berhubungan dengan kode akun yang akan digunakan.</p>
					<ul class="listimage">
					<li>Tekan button hijau (plus) untuk menambahkan kode akun</li>
					<li>Tekan button kuning (pensil) untuk mengubah kode akun</li>
					<li>Tekan button merah (tong sampah) untuk menghapus kode akun</li>
					</ul>
					*note untuk menghapus kode akun, pastikan item dan kategori item yang bersangkutan dengan kode akun sudah terhapus.
					</div>
					</img>
					</div>
