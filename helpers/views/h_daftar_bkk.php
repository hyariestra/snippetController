...
<body>
	...
	<div class="modal-shiftfix" style="position:relative; background:#ccc;">
		...
		<div class="container-fluid main-content">
			<div class="row">
				<div class="col-lg-12">
				<h3>Mengelola Data Pengeluaran</h3>
					<div class="thumbnail">
					<img alt="imgscreenshot" style ="height:300px; width:75%; display: block;" src="../assets/images/screenshots/daftar_bkk.png" data-holder-rendered="true">
					<div class="caption">
					<h3> Screenshot Daftar BKK</h3>
					<p> Modul ini digunakan untuk mengolah data BKK.</p>
					<ul class="listimage">
					<li>Untuk menambah BKK tekan button tambah</li>
					<li>Untuk menghapus satuan data BKK tekan button merah (tong sampah)</li>
					<li>Untuk memilih data BKK yang akan dihapus, centang pada kotak centang, lalu tekan tombol Delete</li>
					<li>Tekan button kuning(pensil) untuk mengubah data</li>
					<li>Tekan button biru (print) untuk mencetak data</li>
					<li>Tekan button Pencarian BKM utuk mencari data BKK</li>
					</ul>
					</div>
					</img>
					</div>
