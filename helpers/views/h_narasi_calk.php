...
<body>
	...
	<div class="modal-shiftfix" style="position:relative; background:#ccc;">
		...
		<div class="container-fluid main-content">
			<div class="row">
				<div class="col-lg-12">
				<h3>Menuliskan Narasi Catatan Atas Laporan Keuangan (CALK)</h3>
					<div class="thumbnail">
					<img alt="imgscreenshot" style ="height:300px; width:75%; display: block;" src="../assets/images/screenshots/narasi_calk.png" data-holder-rendered="true">
					<div class="caption">
					<h3> Screenshot narasi CALK</h3>
					<p> Modul ini digunakan untuk menuliskan narasi CALK.</p>
					<ul class="listimage">
					<li>Tekan button simpan point untuk untuk menyimpan narasi CALK</li>
					</ul>
					</div>
					</img>
					</div>
