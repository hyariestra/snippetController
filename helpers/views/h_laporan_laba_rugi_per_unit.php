...
<body>
	...
	<div class="modal-shiftfix" style="position:relative; background:#ccc;">
		...
		<div class="container-fluid main-content">
			<div class="row">
				<div class="col-lg-12">
				<h3>Menampilkan Laporan Laba Rugi /per unit</h3>
					<div class="thumbnail">
					<img alt="imgscreenshot" style ="height:300px; width:75%; display: block;" src="../assets/images/screenshots/laporan_laba_rugi.png" data-holder-rendered="true">
					<div class="caption">
					<h3> Screenshot laporan Laporan Laba Rugi /per unit</h3>
					<p> Modul ini digunakan untuk menampilkan Laporan Laba Rugi /per unit.</p>
					<ul class="listimage">
					<li>Tekan button print preview untuk untuk menampilkan Laporan Laba Rugi /per unit</li>
					<li>Tekan button print data untuk untuk mencetak Laporan Laba Rugi /per unit</li>
					</ul>
					</div>
					</img>
					</div>
