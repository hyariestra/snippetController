...
<body>
	...
	<div class="modal-shiftfix" style="position:relative; background:#ccc;">
		...
		<div class="container-fluid main-content">
			<div class="row">
				<div class="col-lg-12">
				<h3>Mengelola Data Periode Transaksi</h3>
					
					<div class="thumbnail">
					<img alt="imgscreenshot" style ="height:300px; width:75%; display: block;" src="../assets/images/screenshots/periode_transaksi.png" data-holder-rendered="true">
					<div class="caption">
					<h3> Screenshot Periode Transaksi</h3>
					<p> Modul ini digunakan untuk persiapan awal yang berhubungan dengan proses transaksi keuangan dan akuntansi.</p>
					<ul class="listimage">
					<li>Pilih bulan awal</li>
					<li>Pilih tahun periode</li>
					<li>Tekan button simpan setting untuk menyimpan data</li>					
					</ul>
					</div>
					</img>
					</div>
