		...
		<div class="container-fluid main-content">
			<div class="row">
				...
				<h3>Mengelola Data Pemasok</h3>
					...
					<div class="thumbnail">
					<img alt="imgscreenshot" style ="height:300px; width:75%; display: block;" src="../assets/images/screenshots/pemasok.png" data-holder-rendered="true">
					<div class="caption">
					<h3> Screenshot Data Pemasok</h3>
					<p> Modul ini digunakan untuk persiapan awal yang berhubungan dengan data pemasok.</p>
					<ul class="listimage">
