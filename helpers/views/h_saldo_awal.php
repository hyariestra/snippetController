...
<body>
	...
	<div class="modal-shiftfix" style="position:relative; background:#ccc;">
		...
		<div class="container-fluid main-content">
			<div class="row">
				<div class="col-lg-12">
				<h3>Mengelola Data Saldo Awal</h3>
					
					<div class="thumbnail">
					<img alt="imgscreenshot" style ="height:300px; width:75%; display: block;" src="../assets/images/screenshots/saldo_awal.png" data-holder-rendered="true">
					<div class="caption">
					<h3> Screenshot Daftar Saldo Awal</h3>
					<p> Modul ini digunakan untuk menetapkan saldo awal.</p>
					<ul class="listimage">
					<li>Isi nominal pada form Aset</li>
					<li>Isi nominal pada form Kewajiban</li>
					<li>Isi nominal pada form Ekuitas</li>
					<li>Tekan button simpan data untuk menyimpan data saldo awal</li>
					</div>
					</img>
					</div>
