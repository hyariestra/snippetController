...
<body>
	...
	<div class="modal-shiftfix" style="position:relative; background:#ccc;">
		...
		<div class="container-fluid main-content">
			<div class="row">
				<div class="col-lg-12">
				<h3>Mengelola Data Daftar Akun</h3>
					
					<div class="thumbnail">
					<img alt="imgscreenshot" style ="height:300px; width:75%; display: block;" src="../assets/images/screenshots/daftar_akun.png" data-holder-rendered="true">
					<div class="caption">
					<h3> Screenshot Daftar Akun</h3>
					<p> Modul ini digunakan untuk melihat daftar akun yang telah dibuat dan mencetaknya.</p>
					<ul class="listimage">
					<li>Tekan button hijau (cetak daftar akun excel) untuk mencetak daftar akun dalam format worksheet</li>
					<li>Tekan button kuning (cetak daftar akun pdf) untuk mencetak daftar akun dalam format pdf</li>
					</div>
					</img>
					</div>
