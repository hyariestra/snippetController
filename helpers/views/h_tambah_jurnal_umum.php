...
<body>
	...
	<div class="modal-shiftfix" style="position:relative; background:#ccc;">
		...
		<div class="container-fluid main-content">
			<div class="row">
				<div class="col-lg-12">
				<h3>Menambah Data Jurnal Umum</h3>
					<div class="thumbnail">
					<img alt="imgscreenshot" style ="height:300px; width:75%; display: block;" src="../assets/images/screenshots/tambah_jurnal_umum.png" data-holder-rendered="true">
					<div class="caption">
					<h3> Screenshot Tambah Jurnal Umum</h3>
					<p> Modul ini digunakan untuk menambah data jurnal umum.</p>
					<ul class="listimage">
					<li>Tekan button simpan template untuk menyimpan tempalte jurnal umum</li>
					<li>Tekan button ambil template untuk mengambil data template jurnal umum</li>
					<li>Tekan button plus untuk menambah form data transaksi debit kredit</li>
					<li>Tekan button x untuk menghapus form data transaksi debit kredit</li>
					<li>Tekan button simpan data untuk menyimpan data jurnal umum</li>
					</ul>
					<p>*note untuk menyimpan data, pastikan data debit credit sudah balance</p>
					</div>
					</img>
					</div>
				</div>
