		...
		<div class="container-fluid main-content">
			<div class="row">
				...
				<h3>Mengelola Data Penerimaan</h3>
					...
					<div class="thumbnail">
					<img alt="imgscreenshot" style ="height:300px; width:75%; display: block;" src="../assets/images/screenshots/tambah_penerimaan.png" data-holder-rendered="true">
					<div class="caption">
					<h3> Screenshot Penerimaan</h3>
					<p> Modul ini digunakan untuk menambah data penerimaan.</p>
					<ul class="listimage">
					...
					<li>Tekan daftar BKM untuk melihat daftar buku kas masuk yang sudah tersimpan</li>
					</ul>
					</div>
					</img>
					</div>
