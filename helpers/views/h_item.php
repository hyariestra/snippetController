...
<body>
	...
	<div class="modal-shiftfix" style="position:relative; background:#ccc;">
		...
		<div class="container-fluid main-content">
			<div class="row">
				<div class="col-lg-12">
				<h3>Mengelola Data Item</h3>
					
					<div class="thumbnail">
					<img alt="imgscreenshot" style ="height:300px; width:75%; display: block;" src="../assets/images/screenshots/item.png" data-holder-rendered="true">
					<div class="caption">
					<h3> Screenshot Item</h3>
					<p> Modul ini digunakan untuk persiapan awal yang berhubungan dengan item yang akan digunakan.</p>
					<ul class="listimage">
					<li>Tekan button hijau (plus) untuk menambahkan item</li>
					<li>Tekan button kuning (pensil) untuk mengubah item</li>
					<li>Tekan button merah (tong sampah) untuk menghapus item</li>
					</ul>
					</div>
					</img>
					</div>
