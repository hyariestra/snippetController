		...
		<div class="row">
			<div class="col-md-6">
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<button type="button" onclick="caridatabukaspengeluaran()" class="btn btn-sm btn-default">
							<span class="glyphicon glyphicon-search"></span>
							Cari Data
						</button>
						<button type="button" onclick="printdatabukaspengeluaran()" class="btn btn-sm btn-warning">
							<span class="glyphicon glyphicon-search"></span>
							Print Data
						</button>
...
<script type="text/javascript">
	...
	function loadGridData(){  
  	...
  	function caridatabukaspengeluaran()
  	{
  		var target = "<?php echo site_url("laporan/caribukaspengeluan")?>";
	...
	function printdatabukaspengeluaran()
	{
		caridatabukaspengeluaran();
		var target = "<?php echo site_url("laporan/printbukaspengeluaran")?>/"+$("input[name='tanggalawal']").val()+"/"+$("input[name='tanggalakhir']").val();
