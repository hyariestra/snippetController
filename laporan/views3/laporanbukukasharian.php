...
<script type="text/javascript">
	...
	function caridata()
	{
		...
		$.post(target, data, function(e){
			...
			if(dataLength > 0)
			{
				...
				$(koplong).insertAfter('#lapperubdana > tbody > tr:eq(0)');
			}
	...
	function printdata()
	{
		var target = "<?php echo site_url("laporan/printbukasharian")?>/"+$("input[name='tanggalawal']").val()+"/"+$("input[name='tanggalakhir']").val();
