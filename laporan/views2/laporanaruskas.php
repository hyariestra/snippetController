			...
			<div class="form-horizontal">
				...
				<div class="form-group">
					...
					<div class="col-md-9">
						...
						<button type="button" onclick="printdataaruskas()" class="btn btn-sm btn-success">
...
<script type="text/javascript">
	...
	function previewdata()
	{
		...
		var target = "<?php echo site_url("laporan/previewlaporanaruskas")?>";
			data = {
	...
	function printdataaruskas()
	{
		previewdata();

		var periode = $("select[name='periode']").val();
			nilai = $("select[name='nilai']").val();
		var target  = "<?php echo site_url("laporan/previewlaporanaruskas") ?>/pdf/"+periode+"/"+nilai;
		window.open(target);
	}

	function printdataneraca()
	{
		var target  = "<?php echo site_url("laporan/printneracasaldo") ?>";
		window.open(target);
	}
