		...
		<div class="row">
			<div class="col-md-6">
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<button type="button" onclick="caridatapembelianpersediaan()" class="btn btn-sm btn-default">
							<span class="glyphicon glyphicon-search"></span>
							Cari Data
						</button>
						<button type="button" onclick="printdatapembelianpersediaan()" class="btn btn-sm btn-warning">
							<span class="glyphicon glyphicon-search"></span>
							Print Data
						</button>
			...
			<table id="datatable" class="table table-bordered table-striped">
				...
				<tbody id="inibodi">
					<?php
						...
						$saldoakhir = 0;
						$total = 0;
						foreach($kaspengeluaran->result() as $row)
						{
...
<script type="text/javascript">
	...
	function loadGridData(){  
  	...
  	function caridatapembelianpersediaan()
  	{
  		var target = "<?php echo site_url("laporan/caripembelianpersediaan")?>";
		...
		$.post(target, data, function(e){
			...
			{
				var nom = x + 1;
				konten += "<tr><td>"+nom+"</td><td>"+jojon.bukas[x].tanggal+"</td><td>"+jojon.bukas[x].nobukti+"</td><td>"+jojon.bukas[x].keterangan+"</td><td style='text-align:right;'>0.00</td><td style='text-align:right;'>"+jojon.bukas[x].total+"</td><td style='text-align:right;'>"+jojon.bukas[x].salad+"</td></tr>";
	...
	function printdatapembelianpersediaan()
	{
		caridatapembelianpersediaan();
		var target = "<?php echo site_url("laporan/printpembelianpersediaan")?>/"+$("input[name='tanggalawal']").val()+"/"+$("input[name='tanggalakhir']").val();
