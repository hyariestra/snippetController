...
<script type="text/javascript">
	...
	function previewdata()
	{
		...
		var target = "<?php echo site_url("laporan/previewlaporanneracasaldo")?>";
			data = {
	...
	function printdataneraca()
	{
		...
		var periode = $("select[name='periode']").val();
			nilai  	= $("select[name='nilai']").val();
		var target  = "<?php echo site_url("laporan/previewlaporanneracasaldo")?>/pdf/"+periode+"/"+nilai;
		window.open(target);
	}
	
	function printdataneraca2()
	{
