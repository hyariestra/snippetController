		...
		<div class="row">
			<div class="col-md-6">
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<button type="button" onclick="caridatabiaya()" class="btn btn-sm btn-default">
							<span class="glyphicon glyphicon-search"></span>
							Cari Data
						</button>
						<button type="button" onclick="printdatabiaya()" class="btn btn-sm btn-warning">
							<span class="glyphicon glyphicon-search"></span>
							Print Data
						</button>
...
<script type="text/javascript">
	...
	function caridatabiaya()
  	{
  		var target = "<?php echo site_url("laporan/caribiaya")?>";
	...
	{
		caridatabiaya();
		var target = "<?php echo site_url("laporan/printbiaya")?>/"+$("input[name='tanggalawal']").val()+"/"+$("input[name='tanggalakhir']").val();
