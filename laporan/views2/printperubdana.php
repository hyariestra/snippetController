...
<page footer="page">
	...
	<div style="font-family:tahoma;text-align:center;">
		<h4 style="text-decoration:underline; line-height:5px;">Laporan Perubahan Dana</h4>
	</div>
	...
	<div style="margin-top:30px; position: relative; width: 755px" >
		<table border="1" style="border-collapse:collapse;">
			...
			<tr>
				...
				<td class="coll-td" style="text-align:right; font-weight: bold; background: #e4e3e3;"> <?php echo number_format($zakat['totZakat']) ?> </td>
			</tr>
			<!-- INFAQ -->
			<tr>
