    ...
    <?php
		...
		switch ($periode) {
			case 'Bulan': $tglHeader = 'Sampai tanggal '.$tanggal." ".$nilai.' - '.GetTahunPeriode(); break;
			case 'Triwulan': $tglHeader = 'Sampai tanggal '.$tanggal." ".$nilai.' - '.GetTahunPeriode(); break;
			case 'Semester': $tglHeader = 'Sampai tanggal '.$tanggal." ".$nilai.' - '.GetTahunPeriode(); break;
...
<?php } ?>
  ...
  <page footer="page">
	<div style="text-align:center;margin-bottom: 15px !important;" >
     ...
     <table class="tabelContent" border='0' style="width: 100%;">
      <col style="width: 100%">
      <tr>
          <td>
