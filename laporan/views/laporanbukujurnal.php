			...
			<div class="form-horizontal">
				...
				<div class="form-group">
					...
					<div class="col-md-9">
						...
						foreach ($kodeakun as $akuns) {
							echo '<option value="'.$akuns->kodePlainText.'">'.$akuns->kodePlainText." - ".$akuns->namaPlainText.'</option>';
						} ?>
						</select>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-md-9">
						...
						<?php foreach ($tipejurnal->result() as $tipe) {
							echo '<option value="'.$tipe->id_sumber_trans.'">'.$tipe->nama.'</option>';
						} ?>
						</select>
					</div>
				</div>
