 ...
 <div class="row">
	<div class="col-md-12">
		...
		<div style="text-align:center; margin-bottom: 15px !important;">
			<h4>Laporan Rekap Penerimaan</h4>
					...
					<table class="table table-bordered table-striped tabelContent" border="1" align="center">
						...
						<thead style="<?php echo $thead ?>">
							<tr>
								...
								<!-- <th style="width: 10%;text-align: center;">Deaaabet</th>
								<th style="width: 10%;text-align: center;">Kredit</th> -->
								<th style="width: 15%;text-align: center;">Penambahan</th> 
						...
						if($kasbank != "-")
						{
							...
							$where = " AND ju.id_bank = (SELECT id_bank FROM mst_bank WHERE mst_bank.id_akunbank = '".$kasbank."')";
						...
						$bukas 	= $this->db->query("SELECT jur.tgl_jurnal AS Tanggal, 
							...
							AND jdet.id_akun IN (SELECT mst_akun.id_akun FROM mst_akun WHERE CONCAT(mst_akun.kode_induk,'.',mst_akun.kode_akun) LIKE '4%')
							and NOT $where
						...
						*/
						...
						ju.id_penjualan AS id, 
						ju.tanggal_penjualan AS tgl, 
						ju.no_transaksi AS no_bukti, 
						ju.keterangan AS keterangan, 
						SUM(judet.jumlah_item * judet.harga) AS debet, 
						CONCAT(0) AS kredit 
						...
						WHERE ju.tanggal_penjualan >= '".$startDate."' AND ju.tanggal_penjualan <= '".$endDate."'
						$where $idunit
...
<!-- 						<td style="text-align:right; padding-right:5px;"><?php echo formatCurrency(0) ?></td>-->
						...
						{ 
							...
							<tr>
								...
								<td style="text-align:left; padding-right:5px;"><?php echo wordwrap($str,20,"<br>\n", 'true'); ?></td>
