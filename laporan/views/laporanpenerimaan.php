		...
		<div class="row">
			<div class="col-md-6">
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<button type="button" onclick="caridatapenerimaan()" class="btn btn-sm btn-default">
							<span class="glyphicon glyphicon-search"></span>
							Cari Data
						</button>
						<button type="button" onclick="printdatapenerimaan()" class="btn btn-sm btn-warning">
							<span class="glyphicon glyphicon-search"></span>
							Print Data
						</button>
...
<script type="text/javascript">
	...
	{
		var target = "<?php echo site_url("laporan/caripenerimaan")?>";
	...
	function printdatapenerimaan()
	{
		caridatapenerimaan();
		var target = "<?php echo site_url("laporan/printpenerimaan")?>/"+$("input[name='tanggalawal']").val()+"/"+$("input[name='tanggalakhir']").val();
