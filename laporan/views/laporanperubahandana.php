<style>
	...
	#totalZakat > td, #totalAmil > td, #totalInfaq > td, #totalNon > td {
		background: #e4e3e3;
	}
			...
			<div class="body-laporan">
				<div class="content-laporan">
					<table class="table table-bordered table-striped" id="lapperubdana">
						...
						<tr id="totalZakat">
							<td style="text-align: right;">
								<span style="font-weight:bold;">Total Dana Zakat</span>
							</td>
							<td style="text-align:right"></td>
						</tr>
						<!-- INFAQ SODAQOH -->
						...
						<tr id="totalInfaq">
							<td style="text-align: right;">
								<span style="font-weight:bold;">Total Dana Infaq</span>
							</td>
							<td style="text-align:right"></td>
						</tr>
						<!-- DANA AMIL -->
						...
						<tr id="totalAmil">
							<td style="text-align: right;">
								<span style="font-weight:bold;">Total Dana Amil</span>
							</td>
							<td style="text-align:right"></td>
						</tr>
						<!-- DANA NONHALAL -->
						...
						<tr id="totalNon">
							<td style="text-align: right;">
								<span style="font-weight:bold;">Total Dana Non-Halal</span>
							</td>
							<td style="text-align:right"></td>
						</tr>
						<!-- JUMLAH SALDO -->
...
<script type="text/javascript">
	...
	function caridata()
	{
		...
		$('#totalAmil').find('td:eq(1)').text(0);
		$('#totalZakat').find('td:eq(1)').text(0);
		$('#totalInfaq').find('td:eq(1)').text(0);
		$('#totalNon').find('td:eq(1)').text(0);
		$('h5').html('');
		...
		$.post(target, data, function(e){
			...
			$('h5').html(jojon.tglHeader);

			// ----- fillgrid -----
			// zakat
			if(jojon.zakat.terima)
			{
				if(jojon.zakat.terima.length > 0)
				{
					var terong = '';
						//total = parseInt(jojon.zakat.totTerima);
						total = jojon.zakat.totTerima;
						console.log(total);
					for(var x=0; x < jojon.zakat.terima.length; x++)
					{
						
						terong += '<tr id="" class="trmZakat"><td style="padding-left:25px;"><span style="">'+jojon.zakat.terima[x].nama_item+'</span></td><td style="text-align:right">'+jojon.zakat.terima[x].total+'</td></tr>';
					}
			...
			if(jojon.zakat.keluar)
			{
				if(jojon.zakat.keluar.length > 0)
				{
					...
					for(var x=0; x < jojon.zakat.keluar.length; x++)
					{
						...
						terong += '<tr id="" class="klrZakat"><td style="padding-left:25px;"><span style="">'+jojon.zakat.keluar[x].nama_item+'</span></td><td style="text-align:right">'+subtot+'</td></tr>';
					}
				...
				$('#totalZakat').find('td:eq(1)').text(jojon.zakat.totZakat);
			}
			// infaq
			if(jojon.infaq.terima)
			{
				if(jojon.infaq.terima.length > 0)
				{
					...
					{
						terong += '<tr id="" class="trmInfaq"><td style="padding-left:25px;"><span style="">'+jojon.infaq.terima[x].nama_item+'</span></td><td style="text-align:right">'+jojon.infaq.terima[x].total+'</td></tr>';
					}
			...
			if(jojon.infaq.keluar)
			{
				if(jojon.infaq.keluar.length > 0)
				{
					...
					for(var x=0; x < jojon.infaq.keluar.length; x++)
					{
						...
						terong += '<tr id="" class="klrInfaq"><td style="padding-left:25px;"><span style="">'+jojon.infaq.keluar[x].nama_item+'</span></td><td style="text-align:right">'+subtot+'</td></tr>';
					}

					$(terong).insertAfter('#penyaluranInfaq');
					$('#totalpenyaluranInfaq').find('td:eq(1)').text(total);
				}
				$('#totalInfaq').find('td:eq(1)').text(jojon.infaq.totInfaq);
			}
			
			// amil
			if(jojon.amil.terima)
			{
				if(jojon.amil.terima.length > 0)
				{
					...
					{
						terong += '<tr id="" class="trmAmil"><td style="padding-left:25px;"><span style="">'+jojon.amil.terima[x].nama_item+'</span></td><td style="text-align:right">'+jojon.amil.terima[x].total+'</td></tr>';
					}
			...
			if(jojon.amil.keluar)
			{
				if(jojon.amil.keluar.length > 0)
				{
					...
					for(var x=0; x < jojon.amil.keluar.length; x++)
					{
						...
						terong += '<tr id="" class="klrAmil"><td style="padding-left:25px;"><span style="">'+jojon.amil.keluar[x].nama_item+'</span></td><td style="text-align:right">'+subtot+'</td></tr>';
					}

					$(terong).insertAfter('#penyaluranAmil');
					$('#totalpenyaluranAmil').find('td:eq(1)').text(total);
				}
				$('#totalAmil').find('td:eq(1)').text(jojon.amil.totAmil);
			}
			...
			if(jojon.non.terima)
			{
				if(jojon.non.terima.length > 0)
				{
					...
					{
						terong += '<tr id="" class="trmNon"><td style="padding-left:25px;"><span style="">'+jojon.non.terima[x].nama_item+'</span></td><td style="text-align:right">'+jojon.non.terima[x].total+'</td></tr>';
					}
			...
			if(jojon.non.keluar)
			{
				if(jojon.non.keluar.length > 0)
				{
					...
					for(var x=0; x < jojon.non.keluar.length; x++)
					{
						...
						terong += '<tr id="" class="klrNon"><td style="padding-left:25px;"><span style="">'+jojon.non.keluar[x].nama_item+'</span></td><td style="text-align:right">'+subtot+'</td></tr>';
					}

					$(terong).insertAfter('#penyaluranNonHalal');
					$('#totalpenyaluranNonHalal').find('td:eq(1)').text(total);
				}
				$('#totalNon').find('td:eq(1)').text(jojon.non.totNon);
			}
			
			// setTotal
			$('#lapperubdana').find('tr:last > td:eq(1)').text(jojon.totalAll);
	...
	function printdata()
	{
		...
		var periode = $("select[name='periode']").val();
			nilai = $("select[name='nilai']").val();
			target = "<?php echo site_url("laporan/printperubdana")?>/"+periode+"/"+nilai;
