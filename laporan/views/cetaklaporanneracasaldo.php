...
<div class="row">
	<div class="col-md-12">
		<div style="text-align:center;">
			...
			<span style="margin-bottom: 10px;">Per 31 Desember <?php echo GetTahunPeriode();?></span>
		</div>
		
		<div class="body-laporan">
			<div class="content-laporan">
				<table border="1" class="table table-bordered table-striped tabelContent">
					<col width="15%">
					<col width="20%">
					<col style="">
					<col width="10%">
					...
					<?php
						...
						foreach($qyrItem->result_array() as $rowItem)
						{
							...
							$debetItem = ($rowItem['saldonormal'] == "D") ? @$nominal : 0;
							$kreditItem = ($rowItem['saldonormal'] == "K") ? @$nominal : 0;
