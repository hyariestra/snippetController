	...
	<div class="row" style="border-bottom:1px dashed #429489; padding-bottom:10px;">
		<div class="col-md-6">
			<div class="form-horizontal">
				...
				<div class="form-group">
					<label class="col-md-3 control-label" id="labelchange">Unit</label>
					<div class="col-md-9" >
...
<script type="text/javascript">
	...
	function previewdata()
	{
		...
		var target = "<?php echo site_url("laporan/previewlaporanoperasional")?>";
			data = {
	...
	function printdata()
	{
		...
		var target  = "<?php echo site_url("laporan/previewlaporanoperasional") ?>/pdf/"+periode+"/"+nilai;
