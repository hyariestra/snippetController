			...
			<table id="datatable" class="table table-bordered table-striped">
				<thead style="background:#429489;">
					<tr>
						...
						<th style="color:#fff;">Jenis Rekening</th>
						<th style="color:#fff;">Mata Uang</th>
						<th style="color:#fff;">Nama Bank</th>
						<th style="color:#fff;">No.Rekening</th>
				...
				<tbody>
					...
					?>
							<tr>
								<td><?php echo $seq; ?></td>
								<td><?php echo $row->nama_jenis_rekening?><input type="hidden" name="id_jenis_rek" id="id_jenis_rek" value="<?php echo $row->id_jenis_rek ?>"/></td>
								<td><?php echo $row->nama_mata_uang?><input type="hidden" name="id_mata_uang" id="id_mata_uang" value="<?php echo $row->id_mata_uang ?>"/></td>
								<td><?php echo $row->nama_bank?></td>
								<td><?php echo $row->no_rekening?></td>
								<td>
									<input type="hidden" class="form-control" id="id_bank" name="id_bank" role="inputtext" value="<?php echo $row->id_bank; ?>"/>
									<button onclick="editdata(this,<?php echo $row->id_bank ?>)" class="btn btn-xs btn-warning">
										<span class="glyphicon glyphicon-pencil"></span>
									</button>
									<button onclick="deletedata(this,<?php echo $row->id_bank ?>)" class="btn btn-xs btn-danger">
